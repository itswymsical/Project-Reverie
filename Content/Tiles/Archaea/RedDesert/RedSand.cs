...
using ReverieMod.Content.Projectiles.Tiles;
using Terraria;
using Terraria.ID;
...
namespace ReverieMod.Content.Tiles.Archaea.RedDesert
{
    public class RedSand : ModTile
    {
        public override string Texture => Assets.Tiles.RedDesert + Name;
