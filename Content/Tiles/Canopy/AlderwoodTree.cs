...
namespace ReverieMod.Content.Tiles.Canopy
{
	public class AlderwoodTree : ModTree
	{
		...
		public override Asset<Texture2D> GetTexture() => ModContent.Request<Texture2D>("ReverieMod/Assets/Textures/Tiles/Canopy/AlderwoodTree");
		...
		public override Asset<Texture2D> GetBranchTextures() => ModContent.Request<Texture2D>("ReverieMod/Assets/Textures/Tiles/Canopy/AlderwoodTree_Branches");
		public override Asset<Texture2D> GetTopTextures() => ModContent.Request<Texture2D>("ReverieMod/Assets/Textures/Tiles/Canopy/AlderwoodTree_Tops");	
